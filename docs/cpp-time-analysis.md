...
- Generated at local time `2026-07-11 11:26:23` on `Windows-11-10.0.26100-SP0` with Python `3.13.1`.
...
| Total completed C++ time | 14.09 min |
| Mean completed time | 8.453 s |
| Median completed time | 0.444 s |
| Max completed time | 1.22 min |
